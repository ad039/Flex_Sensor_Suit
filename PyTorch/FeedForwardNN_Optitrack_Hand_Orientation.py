...
class FSSData(Dataset):
    ...
    def __init__(self, dataset):
        ...
        hand_orientation = dataset[:, 9:12]
        shoulder_orientation = dataset[:, 6:9]
        hand_shoulder_orientation = np.subtract(hand_orientation, shoulder_orientation)
...
with torch.no_grad():
    ...
    axs[0].set_ylabel("Orientation (deg)")
